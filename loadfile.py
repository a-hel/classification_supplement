...
def _get_online_file():
    server = "dataverse.harvard.edu"
    persistent_id = "doi:10.7910/DVN/IBFPZA"
    id_ = _get_id(persistent_id, server=server)
